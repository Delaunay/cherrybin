#!/usr/bin/env python
"""
cherrybin documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "cherrybin"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)


import cherrybin.core  # noqa
...
project = "cherrybin"
_full_version = cherrybin.core.__version__
author = cherrybin.core.__author__
copyright = cherrybin.core.__copyright__
...
htmlhelp_basename = "cherrybin-doc"
